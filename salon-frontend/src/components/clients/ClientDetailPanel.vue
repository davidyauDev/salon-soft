...
<template>
  <section class="panel detail-panel">
    <div v-if="!props.client" class="empty-state">
      <h3>Selecciona un cliente</h3>
      <p>Revisa el detalle completo, historial de atenciones y ventas.</p>
    </div>
    ...
    <div v-else class="detail-grid">
      <div class="profile-card">
        ...
        <div class="profile-actions">
          <button class="btn-ghost" type="button" @click="emit('edit', props.client.id)">Editar cliente</button>
          <button
            class="btn-whatsapp"
            type="button"
